...
fun AppTheme(
    ...
    // Defaults to false so the app's own forest theme is what shows up by default - matches
    // Storage.useDynamicColor's default, see its doc comment. Users can still opt into dynamic
    // color (Android 12+) from Settings.
